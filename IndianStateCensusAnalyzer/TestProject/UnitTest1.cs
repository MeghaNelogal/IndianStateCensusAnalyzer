...
namespace TestProject
{
    public class Tests
    {
        ...
        string path = @"D:\BridgelabzPracticeProblems\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CsvFile\";
